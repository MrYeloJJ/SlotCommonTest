    ...
    def test_in_auto_game_click_start_btn(self):
        ...
        while True:
            ...
            for i in range(10):
                ...
                try:
                    self.assertEqual(slot_rolling, False, "横屏自动游戏过程点击停止按钮，滚轴自动停下后，还会自动旋转！")
                except AssertionError:
                    self.daf.get_screenshot(self.browser)
                    raise
    ...
    def test_in_auto_game_click_start_btn_portrait(self):
        ...
        while True:
                ...
                if slot_status is False:
                    ...
                    if game_status is not None:
                        ...
                        try:
                            ...
                            self.assertEqual(main_menu_expand, "retractL", "竖屏自动游戏过程点击停止按钮，滚轴自动停下后，左侧选项菜单不会保持折叠！")
            ...
            for i in range(10):
                ...
                try:
                    self.assertEqual(slot_rolling, False, "竖屏自动游戏过程点击停止按钮，滚轴自动停下后，还会自动旋转！")
                except AssertionError:
                    self.daf.get_screenshot(self.browser)
                    raise
