...
class TestMainMenu(unittest.TestCase):
    ...
    # 验证横竖屏切换 主菜单按钮显示
    def test_main_menu_btn_visible_switch_screen(self):
        self.common.portrait()
        self.common.loading_bar()
        sleep(1)
        self.common.sound_view_yes_btn_click()
        ...
        visible1 = self.common.main_menu_btn_visible()
        sleep(1)
        self.common.portrait()
        sleep(1)
        visible2 = self.common.main_menu_btn_visible()
        try:
            self.assertEqual(visible1, visible2, "横竖屏切换，主菜单按钮显示状态不一致！")
        except AssertionError:
            self.daf.get_screenshot(self.browser)
            raise
